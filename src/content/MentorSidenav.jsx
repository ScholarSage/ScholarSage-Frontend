  ...
  return (
    ...
    <Box sx={{ display: 'flex'}}> 
      ...
      <Drawer variant="permanent" open={open} >
        ...
        <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Mentor-Dashboard")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Mentor-My-Studnets")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/Mentor-Personality-Types")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Personality Guide" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
        </List>
        <Box sx={{ flexGrow: 1 }} /> 
