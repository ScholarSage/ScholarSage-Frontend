...
export default function UpdateProfile() {
  ...
  const [passwordChangeOption, setPasswordChangeOption] = useState("");
              ...
              <form>
                ...
                >
                  <Grid container spacing={2} sx={{ width: "70%", mt: "1rem" }}>
                    ...
                    <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                      <h2 style={{ color: "#3F51B5" }}>{userData.fname} {userData.lname} <br/>{userData.scnumber}</h2>
                      <Button
                        variant="contained"
                        size="large"
                        sx={{
                    ...
                    <Grid item xs={6} sx={{ padding: "1em 1em 0em 1em !important" }}>
                      <FormControl variant="outlined" sx={{ width: "100%" }}>
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            setPasswordChangeOption(e.target.value)
                          }
                        >
